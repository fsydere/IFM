...
synth_design -top IFM_bd_wrapper -part xczu9eg-ffvb1156-2-e -mode out_of_context
...
write_checkpoint -force -noxdef IFM_bd_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file IFM_bd_wrapper_utilization_synth.rpt -pb IFM_bd_wrapper_utilization_synth.pb"  } 
