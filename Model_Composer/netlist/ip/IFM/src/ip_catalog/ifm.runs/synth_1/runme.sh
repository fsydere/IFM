...
HD_PWD='C:/Users/fsydere/Workspace/IFM/Model_Composer/netlist/ip/IFM/src/ip_catalog/ifm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IFM_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IFM_bd_wrapper.tcl
