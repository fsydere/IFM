function [NoisySignals] = SystemInput(varargin)
...
%   [noisySignals] = RadarPulseTrainGenerator();
%   
%   % Özel parametrelerle
%   [noisySignals] = RadarPulseTrainGenerator('Fc', 50e6, 'PW', 5e-6, 'PlotResults', false);
