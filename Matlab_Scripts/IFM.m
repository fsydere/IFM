function [IFM_results] = IFM(noisySignals,varargin)
% Giriş Parametreleri (isteğe bağlı):
%   'NoisySignals'      - Gürültülü Kompleks Sinyal
...
%   'time_delays'       - Zaman Kaymaları [varsayılan: [2, 4]]
%
% Çıkış:
%   IFM_results         - Her SNR ve zaman kayması için ayrı hesaplanan
%   değerler.
%
% Örnek:
...
%   [IFM_results] = IFM('Fc', 50e6, 'BroadcastTime', 3e-3, 'time_delays', [1,2,3,4]);
    ...
    time_delays = p.Results.time_delays;
