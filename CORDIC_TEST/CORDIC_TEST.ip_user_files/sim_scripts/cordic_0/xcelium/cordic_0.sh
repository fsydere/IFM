...
#
# Script generated by Vivado on Sat Jul 05 16:52:51 +03 2025
...
#
# Usage        : cordic_0.sh
#                cordic_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cordic_0.sh [-reset_run]
#                cordic_0.sh [-reset_log]
#                cordic_0.sh [-help]
#
...
#                script (type 'cordic_0.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_14 -libname c_reg_fd_v12_0_10 -libname xbip_dsp48_wrapper_v3_0_7 -libname xbip_pipe_v3_0_10 -libname c_addsub_v12_0_20 -libname mult_gen_v12_0_23 -libname axi_utils_v2_0_10 -libname cordic_v6_0_24 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_14 c_reg_fd_v12_0_10 xbip_dsp48_wrapper_v3_0_7 xbip_pipe_v3_0_10 c_addsub_v12_0_20 mult_gen_v12_0_23 axi_utils_v2_0_10 cordic_v6_0_24 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "cordic_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cordic_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work cordic_v6_0_24 -V93 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cordic_0
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cordic_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/fsy/Workspace/IFM/CORDIC_TEST/CORDIC_TEST.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cordic_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: cordic_0.sh [-step]\n\
Usage: cordic_0.sh [-lib_map_path]\n\
Usage: cordic_0.sh [-reset_run]\n\
Usage: cordic_0.sh [-reset_log]\n\
Usage: cordic_0.sh [-keep_index]\n\
