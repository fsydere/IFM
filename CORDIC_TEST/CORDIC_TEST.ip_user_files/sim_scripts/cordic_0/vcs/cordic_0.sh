...
design_libs=(xbip_utils_v3_0_14 c_reg_fd_v12_0_10 xbip_dsp48_wrapper_v3_0_7 xbip_pipe_v3_0_10 c_addsub_v12_0_20 mult_gen_v12_0_23 axi_utils_v2_0_10 cordic_v6_0_24 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work cordic_v6_0_24 $vhdlan_opts \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/fsy/Workspace/IFM/CORDIC_TEST/CORDIC_TEST.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key cordic_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cordic_0_simv.daidir vcs_lib c.obj)
