...
#
# Script generated by Vivado on Sun Jul 06 15:28:25 +0300 2025
...
#
# Usage        : div_gen_0.sh
#                div_gen_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                div_gen_0.sh [-reset_run]
#                div_gen_0.sh [-reset_log]
#                div_gen_0.sh [-help]
#
...
# script info
echo -e "div_gen_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./div_gen_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L axi_utils_v2_0_10 -L xbip_pipe_v3_0_10 -L xbip_dsp48_wrapper_v3_0_7 -L mult_gen_v12_0_23 -L floating_point_v7_0_25 -L div_gen_v5_1_24 -L secureip -L xpm --snapshot div_gen_0 xil_defaultlib.div_gen_0 -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb div_gen_0.wdb xsim.dir libdpi.so)
...
Usage: div_gen_0.sh [-step]\n\
Usage: div_gen_0.sh [-lib_map_path]\n\
Usage: div_gen_0.sh [-reset_run]\n\
Usage: div_gen_0.sh [-reset_log]\n\
Usage: div_gen_0.sh [-keep_index]\n\
