...
#
# Script generated by Vivado on Thu Jul 17 17:21:54 +0300 2025
...
#
# Usage        : IFM_0.sh
#                IFM_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                IFM_0.sh [-reset_run]
#                IFM_0.sh [-reset_log]
#                IFM_0.sh [-help]
#
...
# script info
echo -e "IFM_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./IFM_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb IFM_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./IFM_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: IFM_0.sh [-help]\n\
Usage: IFM_0.sh [-step]\n\
Usage: IFM_0.sh [-lib_map_path]\n\
Usage: IFM_0.sh [-reset_run]\n\
Usage: IFM_0.sh [-reset_log]\n\
Usage: IFM_0.sh [-keep_index]\n\
Usage: IFM_0.sh [-noclean_files]\n\n\
